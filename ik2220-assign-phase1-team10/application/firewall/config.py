...
RULES = {
    ...
    'fw2_rules':[
        # source, destination, protocol, port, allow?
        ('100.0.0.1/32', '100.0.0.40/30', ipv4.TCP_PROTOCOL, 80, True),
        ('100.0.0.1/32', '100.0.0.20/30', ipv4.TCP_PROTOCOL, 53, True),
        ('100.0.0.1/32', '100.0.0.20/30', ipv4.UDP_PROTOCOL, 53, True),
